		...
		<div className={styles.viewport}>
			...
			<CardGroup title="Board Actions">
				<section className={styles.boardActions}>
					<Button label="Start new game" icon={<AiOutlinePlusCircle className={`${styles.iconSize} ${styles.boardIconColor}`} />} />
					<Button label="Reset the board" icon={<AiOutlineReload className={`${styles.iconSize} ${styles.boardIconColor}`} />} />
				</section>
			</CardGroup>
